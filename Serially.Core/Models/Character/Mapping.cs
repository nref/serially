...
namespace Serially.Core.Models.Character
{
  ...
  {
    public static readonly char Null = (char)ASCII.NULL;
    public static readonly char Esc = (char)ASCII.ESC;
    public static readonly char LeftBracket = (char)ASCII.LeftBracket;
    public static readonly char Delete = (char)ASCII.DEL;
