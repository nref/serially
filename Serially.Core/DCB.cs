...
namespace Serially.Core
{
  ...
  internal class DCB
  {
    ...
    public RtsControlFlags fRtsControl
        {
            get => (RtsControlFlags)Control[RTSsect];
            set => Control[RTSsect] = (int)value;
        }

    public bool fAbortOnError
        {
            get => Control[(int)ctrlBit.fAbortOnErrorMask];
